...
train-anatoliy_belov-clips:
	python main.py --dataset anatoliy_belov-clips --input_height=300 --output_height=128 --is_crop True --input_fname_pattern "*.jpg" --is_train --samples_rate=50 --c_dim=1 --checkpoint_rate=100 --epoch 1000
